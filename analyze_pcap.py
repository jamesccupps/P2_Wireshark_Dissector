...
KNOWN_ERRORS = {
    # Common
    0x0002: "object_unknown (E2)",
    0x0003: "not_found (E3)",
    0x00AC: "not_supported (E172)",
    0x0E11: "already_exists (E3601; treat as success)",
    0x0E15: "physical_point_not_commandable (E3605; retry 0x0240→0x4222)",
    # Vendor-documented
    ...
    0x0009: "already_exists_v2 (E9)",
    0x000A: "trend_already_exists (E10)",
    0x000B: "value_out_of_range (E11)",
    0x000C: "line_not_traced (E12)",
    0x000D: "line_state_mismatch (E13)",
    0x0016: "has_unresolved_points (E22)",
    0x0028: "line_accessed_not_traced (E40)",
    0x0040: "tiu_busy (E64)",
    ...
    0x00FE: "monitor_list_full (E254)",
    0x0200: "flt_transfer_in_progress (E512)",
    ...
    0x0E14: "physical_point_not_commandable_v2 (E3604)",
    0x0E16: "value_out_of_range_v2 (E3606)",
